...
with DAG('user_processing', 
  ...
  storing_user = BashOperator(
    ...
    ## command we need to execute in order to import the user inside your secure database
...
with DAG('user_processing', 
  ...
  creating_table >> is_api_available >> extracting_user >> preocessing_user >> storing_user
```
...
## DAG Scheduling
![image](pics/dag_scheduler.png)

## Backfilling and catchup
Note: All non trigger dag runs will be ru automatically by airflow in order to catch up 
- catchup = True by default

All dat are in UTC
- change it i airflow.cfg
